...
lastWeekToday.setTime(lastWeekToday.getTime()-(7 * 24 * 60 * 60 * 1000));
var year = lastWeekToday.getFullYear();
var month = lastWeekToday.getMonth() + 1;
var date = ('0' + lastWeekToday.getDate()).slice(-2) ;
var dateString = year +""+ month +date;
var targetDt = "&targetDt="+dateString;
